...
//		PartTimeEmployee pEmp2 = new PartTimeEmployee("Melissa", "Will", "123456666", 23.5);
		...
		emp3.whoAmI();
		// TODO To complete
		// emp3.whoAmI() // prints PART TIME EMPLOYEE because it uses the whoAmI() in PartTimeEmployee class
		// emp3.getHourlyRate(); // returns syntax error because the class Employee doesn't have a getHourlyRate() method
...
//		 PartTimeEmployee pEmp3 = (PartTimeEmployee) emp1;
		...
		// because emp1 can not be downcasted to a subclass since the superclass doesnt fit into the subclass.
